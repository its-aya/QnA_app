...
class BackendService {
  ...
  getRequests() {
    return _asyncToGenerator(function* () {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default()({
        method: "GET",
        "url": "https://thebaselabs.com/directus/public/tradezone/items/request?fields=id,title,owner.id,description,request_status.status",
        // your api url
        headers: {
